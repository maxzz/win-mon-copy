...
async function webLoadFilesContent(dropItems: DropItem[]): Promise<R2MInvoke.FileContent[]> {
    const res: R2MInvoke.FileContent[] = [];
...
export async function webLoadDataTransferContent(dataTransferItemList: DataTransferItemList, allowedExt?: string[]): Promise<R2MInvoke.FileContent[]> {
...
export async function webLoadDialogOpen(files: File[], allowedExt?: string[]): Promise<R2MInvoke.FileContent[]> {
